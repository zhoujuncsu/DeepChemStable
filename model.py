...
def build_loss_network(
    ...
    with tf.name_scope("loss") as loss_scope:
        ...
        cross_entropy = scaled * tf.reduce_sum(tf.nn.weighted_cross_entropy_with_logits(targets=labels, logits=normed_predictions, pos_weight=model_params["pos_weight"]))
